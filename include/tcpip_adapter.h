 ...
 * re-defined.
 *
 * esp_tcpip_adapter_init should be called in the start of app_main for only once.
 *
...
#include <stdint.h>
#include ""
#include "/home/marioneto/Documents/PlatformIO/Projects/Dojo/esp-idf/components/esp32/include/rom/queue.h"
 ...
 */
void esp_tcpip_adapter_init(void);
 ...
 *         ESP_ERR_NO_MEM
 */
esp_err_t esp_tcpip_adapter_start(tcpip_adapter_if_t tcpip_if, uint8_t *mac, tcpip_adapter_ip_info_t *ip_info);

/**
 * @brief  Stop an interface
 *
 * The interface will be esp_cleanup in this API, if DHCP server/client are started, will be stopped.
 *
 ...
 */
esp_err_t esp_tcpip_adapter_stop(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_IF_NOT_READY
 */
esp_err_t esp_tcpip_adapter_up(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_IF_NOT_READY
 */
esp_err_t esp_tcpip_adapter_down(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS
 */
esp_err_t esp_tcpip_adapter_get_ip_info(tcpip_adapter_if_t tcpip_if, tcpip_adapter_ip_info_t *ip_info);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS
 */
esp_err_t esp_tcpip_adapter_set_ip_info(tcpip_adapter_if_t tcpip_if, tcpip_adapter_ip_info_t *ip_info);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS
 */
esp_err_t esp_tcpip_adapter_create_ip6_linklocal(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS
 */
esp_err_t esp_tcpip_adapter_get_ip6_linklocal(tcpip_adapter_if_t tcpip_if, ip6_addr_t *if_ip6);
 ...
 * @return ESP_OK
 */
esp_err_t esp_tcpip_adapter_dhcps_get_status(tcpip_adapter_if_t tcpip_if, tcpip_adapter_dhcp_status_t *status);
 ...
 */
esp_err_t esp_tcpip_adapter_dhcps_option(tcpip_adapter_option_mode_t opt_op, tcpip_adapter_option_id_t opt_id, void *opt_val, uint32_t opt_len);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_DHCP_ALREADY_STARTED
 */
esp_err_t esp_tcpip_adapter_dhcps_start(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_IF_NOT_READY
 */
esp_err_t esp_tcpip_adapter_dhcps_stop(tcpip_adapter_if_t tcpip_if);
 ...
 * @return ESP_OK
 */
esp_err_t esp_tcpip_adapter_dhcpc_get_status(tcpip_adapter_if_t tcpip_if, tcpip_adapter_dhcp_status_t *status);
 ...
 * @return ESP_OK
 */
esp_err_t esp_tcpip_adapter_dhcpc_option(tcpip_adapter_option_mode_t opt_op, tcpip_adapter_option_id_t opt_id, void *opt_val, uint32_t opt_len);
 ...
 */
esp_err_t esp_tcpip_adapter_dhcpc_start(tcpip_adapter_if_t tcpip_if);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_IF_NOT_READY
 */
esp_err_t esp_tcpip_adapter_dhcpc_stop(tcpip_adapter_if_t tcpip_if);



esp_err_t esp_tcpip_adapter_eth_input(void *buffer, uint16_t len, void *eb);
 ...
 * @return ESP_OK
 */
esp_err_t esp_tcpip_adapter_sta_input(void *buffer, uint16_t len, void *eb);
 ...
 * @return ESP_OK
 */
esp_err_t esp_tcpip_adapter_ap_input(void *buffer, uint16_t len, void *eb);
 ...
 *         ESP_IF_MAX
 */
esp_interface_t esp_tcpip_adapter_get_esp_if(void *dev);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS
 */
esp_err_t esp_tcpip_adapter_get_sta_list(wifi_sta_list_t *wifi_sta_list, tcpip_adapter_sta_list_t *tcpip_sta_list);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_IF_NOT_READY:interface status esp_error
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS:parameter esp_error
 */
esp_err_t esp_tcpip_adapter_set_hostname(tcpip_adapter_if_t tcpip_if, const char *hostname);
 ...
 *         ESP_ERR_TCPIP_ADAPTER_INVALID_PARAMS:parameter esp_error
 */
esp_err_t esp_tcpip_adapter_get_hostname(tcpip_adapter_if_t tcpip_if, const char **hostname);
